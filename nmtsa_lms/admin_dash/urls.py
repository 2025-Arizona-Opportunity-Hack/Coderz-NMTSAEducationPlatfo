...
urlpatterns = [
    ...
    path('courses/review/<slug:course_slug>/', views.review_course_action, name='admin_review_course_action'),
    path('courses/review/<slug:course_slug>/preview/', views.admin_course_preview, name='admin_course_preview'),
]
